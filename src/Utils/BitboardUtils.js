 ...
 */
export function getRay(startRank, startFile, destinationRank, destinationFile, includeStart = true, includeDestination = true) {
 ...
 */
export function reverseBitboard(bitboard) {
 ...
 */
export function twosComplement(binaryString) {
 ...
 */
export function getBooleanBitboard(bool) {
